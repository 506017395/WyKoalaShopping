...
//  })
    //奶粉馆
    $.getJSON("../static/json/index3.json", function (data) {
        for (i = 0; i < data.length; i++) {
            var obj = data[i];
            var li = $("<li></li>");
            li.css("position", "relative")
...
//  		}
    ...
    //辅食保健
    $.getJSON("../static/json/index4.json", function (data) {
        for (i = 0; i < data.length; i++) {
            var obj = data[i];
            var li = $("<li></li>");
            li.css("position", "relative")
    ...
    //童装童鞋
    $.getJSON("../static/json/index5.json", function (data) {
        for (i = 0; i < data.length; i++) {
            var obj = data[i];
            var li = $("<li></li>");
            li.css("position", "relative")
...
//  		}
    ...
    //孕妇专区
    $.getJSON("../static/json/index6.json", function (data) {
        for (i = 0; i < data.length; i++) {
            var obj = data[i];
            var li = $("<li></li>");
            li.css("position", "relative")
...
//          }
    ...
    //服饰
    $.getJSON("../static/json/index7.json", function (data) {
        for (i = 0; i < data.length; i++) {
            var obj = data[i];
            var li = $("<li></li>");
            li.css("position", "relative")
